        ...
        <div style="background:white; padding:40px; border:1.5px solid #000; font-family:Arial; margin-top:30px; color:#1e293b;">
            ...
            <div style="display:flex; flex-wrap:wrap; gap:40px; align-items:flex-start;">
                ...
                <div style="flex:1; min-width:250px;">
                    <canvas id="chartPie" style="max-height:160px;"></canvas>
                    <div id="legendaColori" style="margin-top:20px; font-size:10px; line-height:1.4;"></div>
                </div>

                <div style="flex:1.2; min-width:280px; border:1.5px solid #000; padding:15px;">
                    ...
                    <div style="font-size:10px; border-top:1px solid #000; padding-top:10px; margin-bottom:20px;">
                        ${frasiEtichetta.join('<br><br>')}
                    </div>
                    
                    <div style="border-top:1px dashed #ccc; padding-top:12px;">
                        <h4 style="text-align:center; font-size:10px; margin:0 0 10px 0; color:#64748b;">SICUREZZA CANDELA (EN 15494)</h4>
            ...
            <div style="text-align:center; margin-top:30px;">
                <button onclick="salvaInArchivio()" style="background:#1e293b; color:white; padding:10px 20px; border:none; cursor:pointer; border-radius:8px;">SALVA IN ARCHIVIO</button>
            </div>
        </div>
    `;
